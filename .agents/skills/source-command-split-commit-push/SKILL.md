---
name: "source-command-split-commit-push"
description: "Split all pending changes into meaningful, separately buildable commits, run tests after each, then push."
---

# source-command-split-commit-push

Use this skill when the user asks to run the migrated source command `split-commit-push`.
